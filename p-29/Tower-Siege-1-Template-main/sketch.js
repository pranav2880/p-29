...
function setup() {
  ...
  //stand2 blocks02
  block06 = new Block(655,135,30,40);
  block07 = new Block(685,135,30,40);
  block08 = new Block(715,135,30,40);
  block09 = new Block(745,135,30,40);
  //stand2 block03
  block010 = new Block(670,95,30,40);
  block011 = new Block(700,95,30,40);
  block012 = new Block(730,95,30,40);
  //stand2 block04
  block013 = new Block(700,55,30,40)
  //polygon
